        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TextMessage = table.Column<string>(type: "TEXT", maxLength: 300, nullable: false),
                    TimeOfMessage = table.Column<DateTime>(type: "TEXT", nullable: false),
                    SentByUserId = table.Column<int>(type: "INTEGER", nullable: false),
                    SentToUserId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Messages_Users_SentToUserId",
